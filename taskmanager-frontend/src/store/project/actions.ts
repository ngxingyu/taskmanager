...
export interface ProjectCreateAction extends Action { type: ProjectActionTypes.CREATE; }
export interface ProjectCreatingAction extends Action { type: ProjectActionTypes.CREATING; }
...
export interface ProjectUpdateAction extends Action { type: ProjectActionTypes.UPDATE; }
export interface ProjectUpdatingAction extends Action { type: ProjectActionTypes.UPDATING; }
...
export interface ProjectDeleteAction extends Action { type: ProjectActionTypes.DELETE; }
export interface ProjectDeletingAction extends Action { type: ProjectActionTypes.DELETING; }
...
export interface ProjectRetrieveAction extends Action { type: ProjectActionTypes.RETRIEVE; }
export interface ProjectRetrievingAction extends Action { type: ProjectActionTypes.RETRIEVING; }
...
export interface ProjectDropAllAction extends Action { type: ProjectActionTypes.DROP_ALL }
...
export type ProjectAction = ProjectCreateAction | ProjectCreatingAction | ProjectCreatedAction | ProjectCreateFailedAction |
    ...
    ProjectDropAllAction | ProjectSelectAction;